...
export default function AnimeCard({ anime }) {
  ...
  return (
    <Link
      ...
      className="group flex flex-col overflow-hidden rounded-2xl bg-white ring-1 ring-zinc-100 transition hover:-translate-y-1 hover:shadow-lg hover:ring-violet-200"
    >
