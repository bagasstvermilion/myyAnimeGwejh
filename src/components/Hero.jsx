...
export default function Hero() {
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="relative mx-auto grid max-w-[1440px] items-center gap-20 px-4 py-16 sm:px-8 sm:py-20 lg:grid-cols-2 lg:gap-12 lg:px-14 lg:py-28">
        <div>
          <p className="text-sm font-semibold uppercase tracking-widest text-violet-600">
            Personal Anime Tracker
          </p>
          <h1 className="mt-4 font-display text-4xl font-semibold leading-[1.05] tracking-tight text-zinc-900 sm:text-5xl lg:text-6xl">
